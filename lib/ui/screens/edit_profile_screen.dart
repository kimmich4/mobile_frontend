        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              AnimateIn(delay: const Duration(milliseconds: 500), child: _buildTextField(context, viewModel.weightController, 'Current Weight (kg)', '70', kb: TextInputType.number)),
              const SizedBox(height: 16),
              AnimateIn(delay: const Duration(milliseconds: 550), child: _buildTextField(context, viewModel.targetWeightController, 'Target Weight (kg)', '65', kb: TextInputType.number)),
              const SizedBox(height: 16),
