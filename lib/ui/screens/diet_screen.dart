      ...
      builder: (context, viewModel, child) {
        ...
        return Scaffold(
          ...
          body:
              viewModel.isLoading
                  ? const Center(
                    child: CircularProgressIndicator(color: Color(0xFF024950)),
                  )
          ...
          Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: () => MainViewModel.switchTabStatic(0),
              ),
              Column(
                children: [
                  const Text(
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: List.generate(
                7,
                (i) => _buildDayItem(viewModel, viewModel.days[i], i),
              ),
            ),
          ),
        ],
        ...
        children: [
          ...
          Container(
            ...
            child: FractionallySizedBox(
              widthFactor:
                  totalMeals > 0
                      ? (completedCount / totalMeals).clamp(0.0, 1.0)
                      : 0.0,
    ...
    return Padding(
      ...
      child: Column(
        children: List.generate(meals.length, (i) {
          ...
          final mealItems =
              (meal['items'] as List)
                  .map((it) => {'name': it['name'], 'cal': it['cal']})
                  .toList();
          return Padding(
  ...
  Widget _buildMealSection(
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color:
            isCompleted
                ? const Color(0xFFE0F2F1).withOpacity(
      ...
      child: Column(
        ...
        children: [
          ...
          ...items.map(
            (item) =>
                _buildMealItem(item['name'] as String, item['cal'] as String),
          ),
          const SizedBox(height: 12),
          SizedBox(
            ...
            child: OutlinedButton.icon(
              ...
              onPressed: () {
                context.read<AiAssistantViewModel>().setPrefillText(
                  'Give me alternatives for these meal items in "$title" for Day ${viewModel.selectedDayIndex + 1} of my diet plan: $itemSummary. Keep the same idea, include portions, and keep the alternatives aligned with my calorie target. send them as bullet points',
                );
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              style: ElevatedButton.styleFrom(
                backgroundColor:
                    isCompleted ? Colors.green : const Color(0xFF964734),
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Row(
              children: [
                const Icon(Icons.circle, size: 8, color: Color(0xFF964734)),
