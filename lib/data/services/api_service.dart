    ...
    try {
      final response = await _client.post(
        ...
        body: jsonEncode({
          ...
          'disliked_foods': userProfile['dislikedFoods'] ?? '',
          'injuries': (userProfile['currentInjuries'] as List?)?.join(', ') ?? '',
          'experience_level': userProfile['experienceLevel'] ?? '',
          'training_days_per_week': userProfile['trainingDaysPerWeek'],
          'preferred_workout_split': userProfile['preferredWorkoutSplit'] ?? '',
