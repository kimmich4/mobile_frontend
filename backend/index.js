...
Foods the user does not like and should be avoided: ${dislikedFoods || 'None'}.
...
5. Ensure the diet plan is safe for the provided allergies/conditions, avoids the user's disliked foods, and doesnt violate any of the vector database constraints.
